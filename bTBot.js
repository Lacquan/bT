...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://raw.githubusercontent.com/Lacquan/bT/master/lang/langindex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://raw.githubusercontent.com/Lacquan/bTBot/master/blacklists/NSFWlist.json",
                OP: "https://raw.githubusercontent.com/Lacquan/bTBot/master/blacklists/OPlist.json",
                BANNED: "https://raw.githubusercontent.com/Lacquan/bTBot/master/blacklists/BANNEDlist.json"
            }
        },
        room: {
            name: null,
            ...
            languageCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.get("https://raw.githubusercontent.com/Lacquan/ECM/master/lang/langindex.json", function (json) {
                            var langIndex = json;
                            var link = langIndex[argument.toLowerCase()];
                            if (typeof link === "undefined") {
                                API.sendChat(subChat(basicBot.chat.langerror, {link: "https://raw.githubusercontent.com/Lacquan/ECM/master/lang/langindex.json"}));
                            }
                            else {
